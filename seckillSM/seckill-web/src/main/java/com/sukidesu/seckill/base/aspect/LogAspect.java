package com.sukidesu.seckill.base.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.sukidesu.seckill.base.common.annotation.Log)")
    ...
    private void saveLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        Log sysLog = new Log();
        com.sukidesu.seckill.base.common.annotation.Log logAnno = method.getAnnotation(com.sukidesu.seckill.base.common.annotation.Log.class);
        if (logAnno != null) {
            // 注解上的描述
