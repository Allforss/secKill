...
import com.sukidesu.seckill.base.model.LogModel;
...
public class LogController extends BaseController {
    ...
    public MessageBean list(int offset, int limit, com.sukidesu.seckill.base.domain.Log log) {
        return this.process(() -> {
            Page<com.sukidesu.seckill.base.domain.Log> page = logService.findPage(offset, limit, log);
